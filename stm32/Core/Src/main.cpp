...
class PWM_SpaceVector
{
public:
	PWM_SpaceVector(PWM_Channel &ch1, PWM_Channel &ch2, PWM_Channel &ch3):
...
static PWM_SpaceVector vec(ch1, ch2, ch3);
...
{
	vec.setNormVoltage(0.5, 360.0f*counter/1000.0f);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|In2_1_Pin|In3_1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin In2_1_Pin In3_1_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|In2_1_Pin|In3_1_Pin;
